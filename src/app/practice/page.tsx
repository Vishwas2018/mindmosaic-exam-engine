...
/* This client-facing setup page is a server component (see the
   ExamConfigurator Suspense boundary below), so it can export metadata
   directly rather than needing a sibling layout the way /exam and
   /results do. */
export const metadata: Metadata = {
  title: "Practice setup",
  description:
    "Set up a Grade 3 or Grade 5 NAPLAN-style or ICAS-style practice session — choose subject, question count and timing. No sign-in required.",
};
