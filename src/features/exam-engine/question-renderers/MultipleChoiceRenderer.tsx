...
import { resolveOptionState } from "./reveal-resolvers";
    ...
    >
      ...
      <div className="grid gap-3" role="radiogroup">
        {question.options.map((option, index) => {
          ...
          const state = reveal ? resolveOptionState(reveal, option.id, isChosen) : undefined;
          ...
          return (
            ...
            >
              <span aria-hidden="true" className={optionLetterClasses(isChosen)}>
