...
export function FitsEveryStudent() {
  return (
    <section aria-labelledby="fits-heading" className="bg-[color-mix(in_srgb,var(--brand)_7%,white)] py-18 sm:py-24">
      <div className="site-width grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
        <div>
          <h2 id="fits-heading" className="font-display text-[clamp(1.75rem,1.35rem+2vw,2.25rem)] font-bold leading-[1.3] tracking-[-0.02em] text-lp-ink">
          ...
          <p className="mt-5 max-w-md font-body text-lg leading-[1.6] text-lp-muted">{fitsEveryStudent.body}</p>
