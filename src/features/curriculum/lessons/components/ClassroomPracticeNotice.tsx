...
export function ClassroomPracticeNotice() {
  return (
    <section
      ...
      className="rounded-2xl border-2 border-primary/20 bg-primary-tint p-6"
    >
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <h2 id="classroom-practice-heading" className="mt-1 font-jakarta text-xl font-bold text-plum-dark">
            Practised in class
          </h2>
          <p className="mt-2 text-[15.5px] leading-relaxed text-plum-muted">
