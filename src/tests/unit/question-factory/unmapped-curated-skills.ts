 ...
 * free-text labels, none of which resolve. It was extended again on
 * 2026-08-11 by the Grade 5 ICAS numeracy promotion: 39 further labels
 * ("Add a power of ten", "Use a cycle remainder", ...), none of which
 * resolve either. Curated free-text skills remain recorded here until an
 * editorial taxonomy mapping is approved.
 *
...
export const UNMAPPED_CURATED_SKILL_LABELS: readonly string[] = [
  ...
  "Combine subtraction and addition",
  ...
  "Infer a function rule",
  "Infer a square side",
  "Infer a whole",
  "Infer a whole from fraction change",
