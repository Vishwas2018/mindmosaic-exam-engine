 ...
 * component). ExamConfigurator itself, and the /practice page that
 * renders it (the marketing root at "/" never imports it), are exempt:
 * they are the one legitimate place selection happens.
 */
...
describe("client route bundle boundaries", () => {
  ...
  it("the practice page is the one place ExamConfigurator (and the bank it needs) is imported", () => {
