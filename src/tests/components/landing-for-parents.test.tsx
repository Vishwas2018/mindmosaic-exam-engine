...
describe("ForParents / Learning insights (landing)", () => {
  // Kept as a stable in-page anchor for deep links, though the header nav no
  // longer carries an "Insights" item — it makes room for About and Help,
  // which are real routes and were footer-only.
  it("exposes a stable #audiences anchor for the learning-insights section", () => {
